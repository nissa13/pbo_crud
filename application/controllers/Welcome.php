...
class Welcome extends CI_Controller {
	...
	public function DataSiswa()
	{
		...
		if($this->uri->segment(4)=='view')
		{
			...
			$tampil=$this->MSudi->GetDataWhere('tbl_siswa1','nis',$nis)->row();
		...
		{	
			$data['DataSiswa']=$this->MSudi->GetData('tbl_siswa1');
			$data['content']='VSiswa';
		}
	...
	public function AddDataSiswa()
	{
		 $add['nis']=$this->input->post('nis');
        	 ...
        	 $this->MSudi->AddData('tbl_siswa1',$add);
	...
	public function UpdateDataSiswa()
	{
		 ...
		 $update['nama']= $this->input->post('nama');
         	 $update['alamat']= $this->input->post('alamat');
          	 $this->MSudi->UpdateData('tbl_siswa1','nis',$nis,$update);
		 redirect(site_url('Welcome/DataSiswa'));
	}
	...
	{
		 $nis=$this->uri->segment('3');
        	 $this->MSudi->DeleteData('tbl_siswa1','nis',$nis);
        	 redirect(site_url('Welcome/DataSiswa'));
	}
